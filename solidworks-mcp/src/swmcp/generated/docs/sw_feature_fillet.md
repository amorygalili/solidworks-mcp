...
Round edges or faces with a constant-radius fillet, addressing them through stable entity references rather than whatever happens to be selected.
...
```json
{
  ...
  "properties": {
    ...
    "propagate": {
      "default": true,
      "description": "Continue across tangent edges.",
      "title": "Propagate",
      "type": "boolean"
    },
    "radius": {
    ...
    "refs": {
      "description": "Edges or faces to round.",
      "items": {
        "$ref": "#/$defs/EntityRef"
      },
      "maxItems": 200,
