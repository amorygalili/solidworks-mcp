...
Delete a feature, optionally with its dependents, and verify it is gone from the tree.
...
```json
{
  ...
  "properties": {
    ...
    "delete_children": {
      "default": false,
      "description": "Also delete features that depend on this one.",
