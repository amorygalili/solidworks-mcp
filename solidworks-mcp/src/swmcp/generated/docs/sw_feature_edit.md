...
Rename a feature or change its suppression state, verified by reading it back.
...
```json
{
  ...
  "properties": {
    ...
    "suppress": {
      ...
      "default": null,
      "description": "True suppresses the feature, False unsuppresses it.",
      "title": "Suppress"
    }
  },
  "required": [
