...
Create a boss or base extrude from a sketch profile, with blind, through-all, up-to, or mid-plane end conditions, draft, and merge control. Verifies the body count and volume actually changed.
