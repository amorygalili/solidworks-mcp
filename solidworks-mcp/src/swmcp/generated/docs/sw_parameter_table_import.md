...
Apply dimension values from a CSV written by the export tool, reporting every row's before and after value and leaving unchanged rows alone.
...
```json
{
  ...
  "properties": {
    ...
    "input_path": {
      "description": "A CSV previously written by the export tool.",
      "title": "Input Path",
      "type": "string"
    },
    "preflight": {
  ...
  "title": "ParameterTableImportArgs",
  "type": "object"
}
```
...
```json
{
  ...
  "title": "ParameterTableImportResult",
  "type": "object"
}
```
