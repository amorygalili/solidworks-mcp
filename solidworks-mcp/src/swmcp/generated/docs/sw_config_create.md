...
Create a configuration, optionally derived from an existing one, and read the configuration list back to confirm it exists.
...
```json
{
  ...
  "properties": {
    "activate": {
      "default": true,
      "description": "Make it the active configuration.",
      "title": "Activate",
      "type": "boolean"
    },
    "alternate_name": {
    ...
    "parent": {
      ...
      "default": null,
      "description": "Create as a derived configuration of this one.",
      "title": "Parent"
    },
    "suppress_new_features": {
      "default": false,
      "description": "New features are suppressed in this configuration by default.",
      "title": "Suppress New Features",
      "type": "boolean"
    }
  },
  "required": [
