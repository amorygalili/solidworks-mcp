...
Hollow a solid to a wall thickness, optionally opening it by removing named faces, and verify that material was actually removed.
...
```json
{
  ...
  "properties": {
    ...
    "outward": {
      "default": false,
      "description": "Add the wall outside the original surface rather than inside.",
      "title": "Outward",
      "type": "boolean"
    },
    "thickness": {
...
```json
{
  ...
  "properties": {
    ...
    "face_count_after": {
      "title": "Face Count After",
      "type": "integer"
    },
    "face_count_before": {
      "title": "Face Count Before",
      "type": "integer"
    },
    "faces_removed": {
      "title": "Faces Removed",
