# sw_sketch_convert_entities

Project existing edges or faces into the active sketch, returning stable ids for the segments that were created.
...
```json
{
  ...
  "properties": {
    ...
    "inner_loops": {
      "default": false,
      "description": "Also convert inner loops of a face.",
      "title": "Inner Loops",
      "type": "boolean"
    },
    "refs": {
      "description": "Edges or faces to project into the sketch.",
      "items": {
        "$ref": "#/$defs/EntityRef"
      },
      "maxItems": 100,
  ...
  "title": "SketchConvertEntitiesArgs",
  "type": "object"
}
```
...
```json
{
  ...
  "title": "SketchConvertEntitiesResult",
  "type": "object"
}
```
