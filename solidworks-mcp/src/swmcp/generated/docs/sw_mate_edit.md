...
Rename a mate or change its suppression, verified by reading the mate list back rather than trusting the call.
...
```json
{
  ...
  "additionalProperties": false,
  "description": "Non-destructive edits only. Deleting a mate is sw_mate_delete, which confirms.",
  "properties": {
    "document": {
      "$ref": "#/$defs/DocTarget",
    ...
    "mate_name": {
      "description": "Mate name as sw_mate_list reports it, e.g. 'Coincident1'.",
      "minLength": 1,
      "title": "Mate Name",
      "type": "string"
    },
    "rename_to": {
      ...
      "default": null,
      "description": "New name for the mate.",
      "title": "Rename To"
    },
    "suppressed": {
      "anyOf": [
      ...
      "default": null,
      "description": "Suppress or unsuppress it.",
      "title": "Suppressed"
    }
  },
  "required": [
