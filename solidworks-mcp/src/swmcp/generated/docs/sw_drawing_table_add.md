...
Insert a bill of materials on the active sheet and read every cell back, so the table's contents are the evidence rather than the call having returned.
...
```json
{
  ...
  "additionalProperties": false,
  "description": "DRW-006, for the BOM half.",
  "properties": {
    "at": {
      "anyOf": [
        {
    ...
    "bom_type": {
      "default": "parts_only",
      "description": "Which BOM to build.",
      "enum": [
        "parts_only",
        "top_level_only",
        "indented",
    ...
    "configuration": {
      ...
      "default": null,
      "description": "Configuration the quantities come from.",
      "title": "Configuration"
    },
    "document": {
      "$ref": "#/$defs/DocTarget",
    ...
    "template_path": {
      ...
      "default": null,
      "description": "Explicit table template.",
      "title": "Template Path"
    }
  },
  "title": "DrawingTableAddArgs",
  "type": "object"
}
```
