...
Measure the model, a body, a feature, or a single face: bounding box, volume, surface area, mass, centre of mass, topology counts, and rebuild validity.
...
```json
{
  "$defs": {
    ...
    "MeasureScope": {
      ...
      "properties": {
        ...
        "document": {
          "default": true,
          "description": "Measure every solid body.",
          "title": "Document",
          "type": "boolean"
        },
        "feature_name": {
        ...
        "ref": {
          ...
          "default": null,
          "description": "Measure a single face or edge."
        }
      },
      "title": "MeasureScope",
      "type": "object"
  ...
  "properties": {
    ...
    "scope": {
      "$ref": "#/$defs/MeasureScope"
    },
    "unit": {
      "default": "mm",
      "description": "Unit for reported lengths.",
      "title": "Unit",
      "type": "string"
    }
  },
