...
Create a coordinate system from an origin and axis references, and return the transform SOLIDWORKS actually built: rotation, origin position, and scale.
...
```json
{
  ...
  "properties": {
    ...
    "flip_x": {
      "default": false,
      "description": "Reverse the resolved X direction.",
      "title": "Flip X",
      "type": "boolean"
    },
    "flip_y": {
      "default": false,
      "description": "Reverse the resolved Y direction.",
      "title": "Flip Y",
      "type": "boolean"
    },
    "flip_z": {
      "default": false,
      "description": "Reverse the resolved Z direction.",
      "title": "Flip Z",
      "type": "boolean"
    },
    "name": {
      ...
      "default": null,
      "description": "Rename the coordinate system afterwards.",
      "title": "Name"
    },
    "origin": {
      "anyOf": [
    ...
    "x_axis": {
      ...
      "default": null,
      "description": "Edge, axis, or line for +X."
    },
    "y_axis": {
      "anyOf": [
        {
      ...
      "default": null,
      "description": "Edge, axis, or line for +Y."
    },
    "z_axis": {
      "anyOf": [
        {
      ...
      "default": null,
      "description": "Edge, axis, or line for +Z."
    }
  },
  "title": "DatumCsysCreateArgs",
  "type": "object"
}
```
...
```json
{
  "$defs": {
    ...
    "DatumCsysTransform": {
      "additionalProperties": false,
      "description": "The created system's placement, read back out of SOLIDWORKS.",
      "properties": {
        "rotation": {
        ...
        "scale": {
          "description": "Uniform scale factor; 1.0 for an ordinary system.",
          "title": "Scale",
          "type": "number"
        },
        "translation_mm": {
          "description": "Origin position in millimetres.",
          "items": {
            "type": "number"
          },
