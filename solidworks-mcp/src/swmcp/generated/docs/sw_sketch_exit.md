...
Close the sketch currently open for editing and optionally rebuild the model.
...
```json
{
  ...
  "properties": {
    ...
    "rebuild": {
      "default": true,
      "description": "Rebuild the model on exiting the sketch.",
      "title": "Rebuild",
      "type": "boolean"
    }
  },
  "title": "SketchExitArgs",
  "type": "object"
}
```
