...
Undo the last operations in SOLIDWORKS. Native undo is opportunistic and does not report what it reverted, so checkpoints remain the reliable way back.
...
```json
{
  ...
  "properties": {
    ...
    "note": {
      "default": "Native undo is not a substitute for a checkpoint: SOLIDWORKS does not report reliably how many steps were actually undone.",
      "title": "Note",
      "type": "string"
    },
    "rebuild_errors": {
