...
Create a surface body by filling a closed sketch, offsetting faces, extending surface edges, or knitting touching surfaces, verified by counting sheet bodies.
...
```json
{
  ...
  "properties": {
    ...
    "edge_refs": {
      "description": "Surface edges to extend.",
      "items": {
        "$ref": "#/$defs/EntityRef"
      },
      "maxItems": 64,
    ...
    "method": {
      "description": "'planar' fills a closed sketch, 'offset' copies faces at a distance (0 copies them in place), 'extend' stretches surface edges, and 'knit' sews touching surfaces into one.",
      "enum": [
        "planar",
        "offset",
        "extend",
    ...
    "reverse": {
      "default": false,
      "description": "Offset the other way.",
      "title": "Reverse",
      "type": "boolean"
    },
    "sketch_name": {
      ...
      "default": null,
      "description": "Closed profile for 'planar'. Defaults to the newest unused.",
      "title": "Sketch Name"
    }
  },
  "required": [
...
```json
{
  ...
  "properties": {
    ...
    "sheet_bodies_after": {
      "title": "Sheet Bodies After",
      "type": "integer"
    },
    "sheet_bodies_before": {
      "title": "Sheet Bodies Before",
      "type": "integer"
    },
    "solid_bodies_after": {
      "title": "Solid Bodies After",
      "type": "integer"
    },
    "verification": {
