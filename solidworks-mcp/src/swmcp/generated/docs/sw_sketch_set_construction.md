# sw_sketch_set_construction

Toggle segments between construction geometry and profile geometry.
...
```json
{
  ...
  "properties": {
    ...
    "segment_ids": {
      "description": "sketch_local_id values from a create call.",
      "items": {
        "type": "string"
      },
      "maxItems": 500,
  ...
  "title": "SketchSetConstructionArgs",
  "type": "object"
}
```
...
```json
{
  ...
  "title": "SketchSetConstructionResult",
  "type": "object"
}
```
