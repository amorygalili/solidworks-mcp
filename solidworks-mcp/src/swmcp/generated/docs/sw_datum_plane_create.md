...
Create a reference plane by offset, angle, midplane, three points, or tangency, and read back the plane that was actually created.
...
```json
{
  ...
  "properties": {
    ...
    "distance": {
      ...
      "default": null,
      "description": "Offset distance for 'offset'.",
      "title": "Distance"
    },
    "document": {
      "$ref": "#/$defs/DocTarget",
    ...
    "flip": {
      "default": false,
      "description": "Reverse the offset or angle direction.",
      "title": "Flip",
      "type": "boolean"
    },
    "method": {
    ...
    "name": {
      ...
      "default": null,
      "description": "Rename the plane after creating it.",
      "title": "Name"
    },
    "refs": {
    ...
    "standard_plane": {
      ...
      "default": null,
      "description": "Use a standard plane as the single reference.",
