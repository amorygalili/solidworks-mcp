...
Read a SOLIDWORKS API member on an allowlisted object. This is a research and diagnostics tool, not a substitute for the typed operations, and it refuses any member that would change state.
