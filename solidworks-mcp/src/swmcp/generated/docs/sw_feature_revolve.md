...
Revolve a sketch profile about an axis to add or remove material. Boss and cut share one tool because their option sets are identical.
...
```json
{
  ...
  "properties": {
    ...
    "axis_ref": {
      ...
      "default": null,
      "description": "Axis of revolution. Defaults to a centerline in the sketch."
    },
    "document": {
      "$ref": "#/$defs/DocTarget",
