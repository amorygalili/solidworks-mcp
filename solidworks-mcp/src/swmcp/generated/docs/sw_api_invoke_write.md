...
Call a state-changing SOLIDWORKS API member directly. Development only: it is gated behind SWMCP_ENABLE_LOWLEVEL_WRITE, requires confirmation, is checkpointed and audited, and its effect is not verified beyond a before and after snapshot.
...
```json
{
  ...
  "properties": {
    "args": {
      "description": "Arguments, JSON scalars only.",
      "items": {},
      "maxItems": 20,
      "title": "Args",
      "type": "array"
    ...
    "member": {
      "description": "Member name to read or call.",
      "maxLength": 80,
      "minLength": 1,
      "title": "Member",
      "type": "string"
    ...
    "ref": {
      ...
      "default": null,
      "description": "Required when target is 'ref': the entity to call on."
    },
    "target": {
      "default": "doc",
      "enum": [
